...
import com.github.pires.obd.reader.activity.MostrarInfo;
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() throws IOException {
        ...
        Log.e(TAG, "ConfigActivity.BLUETOOTH_LIST_KEY --> " + ConfigActivity.BLUETOOTH_LIST_KEY);
        ...
        if (remoteDevice == null || "".equals(remoteDevice)) {
            ...
            // log error
            Log.e(TAG, "No Bluetooth device has been selected. remoteDevice --> " + remoteDevice);
    ...
    protected void executeQueue() throws InterruptedException {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            if (job != null) {
                ...
                try{
                    ((MostrarInfo) ctx).runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((MostrarInfo) ctx).stateUpdate(job2);
                        }
                    });
                }catch(Exception e){
